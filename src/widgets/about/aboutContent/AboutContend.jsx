    ...
    return (
        <div className="aboutContent">
                ...
                <div className="aboutContent_gra">
                    ...
                    <div className="aboutContent_doughnut_content_texts">
                        {pipls.map((item, index) => {
                            ...
                            const count = parseInt(item.n.replace(/\s/g, '')) || 0;
                                ...
                                <div key={index} className="aboutContent_doughnut_content_text">
                                    <div className="aboutContent_doughnut_content_text_block" >
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                            <div style={{ backgroundColor: chartData.datasets[0].backgroundColor[index], width: '20px', height: '20px', borderRadius: '50%' }}></div>
                                            <h2 style={{ margin: 0, fontSize: '16px', fontWeight: 'bold', color: '#333' }}>{count.toLocaleString()}</h2>
                                        </div>
            ...
            <div style={{ width: '100%', marginTop: "100px", height: '300px' }}>
                <Map2GIS mapLink={location} zoom={15} />
            </div>
        </div>
    );
};
